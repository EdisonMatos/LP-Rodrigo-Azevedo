    ...
    <div className="w-full">
      ...
      >
        <Navbar>
          <ScrollLink
            to="home"
            className="cursor-pointer w-[45%] phone2:w-[50%] phone3:w-[45%] tablet1:w-[30%] tablet2:w-[25%] desktop1:w-[25%] desktop2:w-[364px] "
            spy={true}
            smooth={true}
            duration={500}
            offset={-100}
          ...
          >
            <img
              ...
              className={`${
                LightMode
                  ? scrolling
                    ? "bg-transparent w-[80%] tablet1:w-[70%] tablet2:w-[80%] desktop1:w-[70%] px-3 py-3 desktop2:w-[90%] transition-all duration-1000"
                    : " w-full my-[20px] phone3:max-w-[180px] tablet1:w-[90%] desktop1:w-[80%] desktop2:w-full px-3 py-3 transition-all duration-1000"
                  : scrolling
                  ? "bg-transparent w-[70%] phone3:w-[60%] tablet1:w-[80%] tablet2:w-[70%] desktop1:w-[80%] desktop2:w-[90%] transition-all duration-1000"
